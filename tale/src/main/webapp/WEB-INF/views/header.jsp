...
100%{transform:rotate(180deg);background-color:yellow;left:500px;top:0px;}
 ...
 nav{background-color:#326D8D !important;margin-bottom:0px;}
 </style>
</head>
<body>
...
<li><a href="/" class="brand"><img src="<c:url value="/images/logo.jpg"/>" ></a>
</li>
...
<a href="https://github.com/" target=_blank><img src="<c:url value="/images/github.jpg"/>" class="img-rounded"></a>
