...
<img src="<c:url value="/images/ca1.jpg"/>" width="1110px">
</div> 
<div class="item">
<img src="<c:url value="/images/ca2.jpg"/>" width="1110px">
</div>  
<div class="item">
<img src="<c:url value="/images/ca3.jpg"/>" width="1110px">
</div> 
 </div>
...
<c:forEach items="${category.product}" var="product" begin="0" end="0">
<div class=" col-xs-3 " >
