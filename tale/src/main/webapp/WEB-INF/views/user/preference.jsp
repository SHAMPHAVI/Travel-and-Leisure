...
<h2 class=" col-xs-offset-3 text-primary"> Enter your preference</h2>
<h3 class=" col-xs-offset-3 text-warming" id="top"></h3>
<form:form commandName="preference" onsubmit="return valform()">
<div class="row">
...
<div class="row">
<div class="form-group col-xs-offset-3 col-xs-3">
<form:input type="text" class="form-control" path="doorno" placeholder="Date of travel" required="true" id="ship_a1" onblur="doornocheck()"/>
<p class="small text-danger" id="ship_b1"></p>
</div></div>
<div class="row">
<div class="form-group col-xs-offset-3 col-xs-3">

<form:input type="text" path="street" class="form-control" placeholder="preference regarding travel" required="true" id="ship_a2" onblur="streetcheck()"/>
...
<input type="submit" name="_eventId_submitpreference" class=" col-xs-offset-3 btn btn-info" value="proceed"/>
