...
import com.niit.talbackend.dao.SupplierDao;
...
public String home(Model mod,HttpSession session){
		log.debug("opening of landing page ");
...
public String index(Model mod,HttpSession session,Principal p){
		...
		log.debug("return to landing page after purchasing");
		return "index";
	...
	public String contactus(Model mod){
		mod.addAttribute("contactus","true");
