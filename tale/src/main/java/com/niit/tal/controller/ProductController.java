...
import com.niit.tal.util.FileUtil;
...
public class ProductController {
	...
	private String path="/project niit/tale/src/main/webapp/WEB-INF/images";
...
public String addproduct(@ModelAttribute ("addproduct") Product product,@RequestParam("image") MultipartFile file,Model mod,HttpSession session){
	log.debug("products adding process started");
